...
#ifndef AUTOTESTER_MODIFIESSTORE_H
#define AUTOTESTER_MODIFIESSTORE_H
...
private:
    static Relationship<int, string> modifiesS;
    static Relationship<string, string> modifiesP;
};

#endif //AUTOTESTER_MODIFIESSTORE_H

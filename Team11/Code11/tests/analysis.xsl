...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" xmlns:set="http://exslt.org/sets" extension-element-prefixes="set">
	...
	<xsl:template match="test_results">
		<html>
          ...
          CS3203 - Analysis of the Testing for Team <xsl:value-of select="./info/name/text()"/>
				...
				<br/>
				<tables border="3" id="summarytable" width="100%">
					<tr>
						<td width="30%">
              <i>
              ...
              <xsl:value-of select="./info/datetime/text()"/>
				...
				<br/>
				<tables border="3" height="200" id="table3" width="100%" cellspacing="6">
					<tr>
						<td colspan="3">
							<center>
								<b>Summary</b>
          ...
          -->
              ...
              <xsl:value-of select="./info/notes/text()"/>
				...
				<tables border="0" id="tagstable" width="100%">
					<tr>
						<td width="500">
							<tables border="1" height="174" id="table3" width="66%">
								<tr>
									<td colspan="2">
										<b>View By Tags</b>
									</td>
			...
			<xsl:choose>
				<xsl:when test="./passed">
					<div style="border: 1px solid #000000; padding: 0px; background: #EEEEEE;">
						<tables border="0" cellpadding="2" cellspacing="0" style="background: green; color: #FFFFFF;" width="100%">
							<tr>
								<td>
									<b>
                  ...
                  [                                    <a href="javascript: void(0);" id="exp{./id}_link" onclick="toggle(this, &apos;exp{./id}&apos;);" style="text-decoration: none; color: #FFFFFF;" title="show/hide">-</a>
						...
						<div id="exp{./id}" style="padding: 3px;">
							<tables bgcolor="white" border="1" id="table1" width="100%">
              ...
              &apos;);
				...
				<xsl:when test="./timeout">
					<div style="border: 1px solid #000000; padding: 0px; background: #EEEEEE;">
						<tables border="0" cellpadding="2" cellspacing="0" style="background: blue; color: #FFFFFF;" width="100%">
							<tr>
								<td>
									<b>
              ...
              &apos;);
				...
				<xsl:when test="./exception">
					<div style="border: 1px solid #000000; padding: 0px; background: #EEEEEE;">
						<tables border="0" cellpadding="2" cellspacing="0" style="background: brown; color: #FFFFFF;" width="100%">
							<tr>
								<td>
									<b>
              ...
              &apos;);
				...
				<xsl:when test="./crash">
					<div style="border: 1px solid #000000; padding: 0px; background: #EEEEEE;">
						<tables border="0" cellpadding="2" cellspacing="0" style="background: black; color: #FFFFFF;" width="100%">
							<tr>
								<td>
									<b>
              ...
              &apos;);
				...
				<xsl:otherwise>
					<div style="border: 1px solid #000000; padding: 0px; background: #EEEEEE;">
						<tables border="0" cellpadding="2" cellspacing="0" style="background: red; color: #FFFFFF;" width="100%">
							<tr>
								<td>
									<b>
	...
	<xsl:template match="exception">
		<tables bgcolor="white" border="1" id="table3" width="100%">
			<tr>
				<td width="100%">
					<b>
						<pre>Exception :</pre>
	...
	<xsl:template match="failed">
		<tables bgcolor="white" border="1" id="table2" width="100%">
			<tr>
				<td>
					<b>
